...
function showDigestOverlay(kind) {
  ...
  document.getElementById('digest-overlay-gif').src = copy.gif;
...
// then hides the overlay. Always await this — that's what guarantees the
// 3s floor regardless of how fast/slow the real work behind it was.
function hideDigestOverlay() {
