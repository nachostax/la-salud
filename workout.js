  ...
  return `
    <div class="wo-pl-row wo-pl-warmup ${row.completed ? 'done' : ''} ${isCurrent ? 'wo-pl-row-current' : ''}">
      ...
      <div class="wo-pl-hold-btn ${row.completed ? 'checked' : ''}" id="wo-pl-warmup-btn-${i}"
        ...
        <img class="wo-pl-hold-fp wo-pl-hold-fp-white" src="./fingerprintwhite.png" alt="" draggable="false">
        <img class="wo-pl-hold-fp wo-pl-hold-fp-black" src="./fingerprint.png" alt="" draggable="false">
      </div>
    </div>`;
}
