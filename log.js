  ...
  inner.innerHTML = `
    <div style="padding:52px 20px 40px">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
        <div class="trend-card"><div class="trend-stat-label">Duration</div><div style="font-size:24px;font-weight:700;color:${personColor}">${e.duration_min || '—'}<span style="font-size:13px;font-weight:400;color:var(--mist)"> min</span></div></div>
